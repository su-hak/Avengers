...
//     // HTML에서 img 태그를 선택합니다.
//     const imgTag = document.querySelector('img');
//
// // img 태그의 alt 속성 값을 가져옵니다.
// //     const altValue = imgTag.alt;
//     const altValue = $('img').attr('alt');
//
// // alt 속성 값을 출력합니다.
...
function initialize() {
    ...
    // $("#left-item-search").on("input", searchItems);
}
